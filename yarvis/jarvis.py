...
while True:
    ...
    if "jarvis" in command:
        if "hola jarvis" in command:
            ...
            webbrowser.open("http://" + website)  # Agregar "http://" para que funcione correctamente
            speak("OK, Señor Navarro. Aquí tiene la página abierta.")
        elif "jarvis abre youtube" in command:
            speak("¿Qué canción desea reproducir en YouTube?")
        ...
        elif "jarvis abre el bloc de notas" in command:
